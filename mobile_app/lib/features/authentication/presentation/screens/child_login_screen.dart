...
/// Screen: Child Login
/// Allows children to login with their credentials
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // REMOVED - Demo credentials removed from production code
                        
                        const SizedBox(height: 18),

                        // Footer: Ask parent for credentials
                        Center(
                          child: Text(
                            "Ask your parent for login credentials",
                            style: TextStyle(
                              fontSize: 12,
